    ...
    while 1:
        ...
        while len(pulses) > 0:
            ...
            for _ in range(l):
                ...
                if sender in modulesOfInterest and signal == "low":
                    if sender not in stuff:
                        stuff[sender] = numButtonPresses
        ...
        if len(stuff) == 4: break

    return lcm(*stuff.values())
